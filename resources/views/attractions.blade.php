...
<head>
    ...
    @vite(['resources/css/main.css', 'resources/css/contentcss/attractions.css'])
</head>
<body>
    <header>
        <div class="upper">
    ...
    <main>
        ...
        <section class="content">
            <h1>Attractions in Subic</h1>

            <!-- Attraction #1-->
            <div class="place">
                <div class="left">
                    <img src="{{ Vite::asset('resources/images/inflatable.jpg') }}" alt="">
                    <button>Read more</button>
                </div>
                <div class="right">
                    <h2>Attraction #1 in Subic</h2>
            ...
            <!-- Attraction #2 -->
             <div class="place">
                <div class="left">
                    <img src="{{ Vite::asset('resources/images/safari.jpg') }}" alt="">
                    <button>Read more</button>
                </div>
                <div class="right">
                    <h2>Attraction #2 in Subic</h2>
            ...
            <!-- Attraction #3 -->
             <div class="place">
                <div class="left">
                    <img src="{{ Vite::asset('resources/images/moonbay.jpg') }}" alt="">
                    <button>Read more</button>
                </div>
                <div class="right">
                    <h2>Attraction #3 in Subic</h2>
            ...
            <section class="bookingform">
                ...
                <form class="booking" method="POST" action="#">
                    ...
                    <!-- Use Display:block on css to move each input on next line -->
                    <div class="whenWhere">
